<div class="container starter-template">
    <ul class="list-unstyled">
        ...
        <li class="media">
            <a href="https://complemento.net.br/manuais-otrs-complemento/" target="_blank" class="linkVideo">
                <img src="img/manual-otrs.png" alt="">
                <div class="media-body">
                    <div class="imgVideo">
                        <h5 class="mt-0 mb-1">Manuais OTRS</h5>
                        Manuais Complemento OTRS 5.0
                    </div>
                </div>
            </a>
        </li>
